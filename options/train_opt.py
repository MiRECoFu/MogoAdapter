...
class TrainT2MOptions(BaseOptions):
    def initialize(self):
        ...
        '''LR scheduler'''
        self.parser.add_argument('--lr', type=float, default=1.2e-5, help='Learning rate')
...
# python trainers/train_transformotion.py --dataset_name t2m --name trm_xl_b48_d1024_822_clip_nh16_nl18_n8192_downt_1_once --vq_name rvq_n8192_d128 --gpu_id 0