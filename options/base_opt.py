...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--mogo_clip_layers', type=int, default=16, help='Number of attention layers.')
        self.parser.add_argument('--mogo_clip_width', type=int, default=1024, help='FF_Size')
